...
| `API-AG-12` | P1 | Seleção de profissional automatic | `endUserAuth` | 400 | `postPublicCreateAppointmentRace` | — | — | `AG-12-F.test.ts` | [#91](https://github.com/pricaimiTech/dev.CrossHub/issues/91) |
| `API-AG-13` | P1 | Seleção de profissional required | `endUserAuth` | 400 | `postPublicCreateAppointmentRace` | `getPublicAvailability` | — | `AG-13-F.test.ts` | [#91](https://github.com/pricaimiTech/dev.CrossHub/issues/91) |
...
| `API-AG-21` | P1 | Reagendamento encadeia os registros | `tenantAuth` | 200 | `postRescheduleAppointment` | `postCreateAppointment`<br>`getAvailability` | — | `AG-21-F.test.ts` | [#90](https://github.com/pricaimiTech/dev.CrossHub/issues/90) |
...
| `API-AG-28` | P2 | Feriado móvel | `tenantAuth` | 200 | `getCalendar` | — | — | `AG-28-F.test.ts` | [#93](https://github.com/pricaimiTech/dev.CrossHub/issues/93) |
...
| `API-F-03` | P0 | CLOSED é definitivo | `tenantAuth` | 400 | `postPublish` | `postClose`<br>`postDuplicate` | — | `F-03-F.test.ts` | [#95](https://github.com/pricaimiTech/dev.CrossHub/issues/95) |
...
| `API-F-15` | P0 | Submissão única repetida | `endUserAuth` | 409 | `postPublicSubmitForm` | `postPublicSubmitForm` | `trigger` | `F-15-F.test.ts` | [#94](https://github.com/pricaimiTech/dev.CrossHub/issues/94) |
...
| `API-F-21` | P1 | Auditoria de leitura sensível | `tenantAuth` | 200 | `getSubmission` | — | — | `F-21-F.test.ts` | — |
...
| `API-LGPD-02` | P0 | Principal legado sem a flag continua autorizado | `tenantAuth` | 200 | `getSubmission` | — | — | `LGPD-02-F.test.ts` | — |
...
| `API-LGPD-13` | P1 | Auditoria da mudança de acesso | `tenantAuth` | 200 | `patchSensitiveDataAccess` | — | — | `LGPD-13-F.test.ts` | — |
...
| `API-C-02` | P1 | Normalização de campos | `tenantAuth` | 201 | `postCreatePerson` | — | `maria@exemplo.com` | `C-02-F.test.ts` | [#100](https://github.com/pricaimiTech/dev.CrossHub/issues/100) |
...
| `API-C-04` | P0 | Código exige um canal de contato | `tenantAuth` | 409 | `postCreateCode` | — | — | `C-04-F.test.ts` | [#99](https://github.com/pricaimiTech/dev.CrossHub/issues/99) |
...
| `API-C-15` | P1 | Auditoria | `tenantAuth` | 201 | `postCreatePerson` | `patchUpdatePerson`<br>`postCreateCode`<br>`postRegenerateCode`<br>`postRemoveAccess` | — | `C-15-F.test.ts` | — |
...
| Caso | Prio | Cenário | Token | Status | Service (ação) | Services (arranjo) | Asserção literal | Teste | Bug |
|---|---|---|---|---|---|---|---|---|---|
| `API-H-01` | P0 | Janela de 24 h nas reservas | `tenantAuth` | 200 | `getHome` | `postPublicReserveProduct`<br>`patchUpdateReservation` | — | `H-01-F.test.ts` | — |
| `API-H-02` | P1 | Janela de 7 dias nas pessoas | `tenantAuth` | 200 | `getHome` | `postCreatePerson` | — | `H-02-F.test.ts` | — |
...
| `API-H-09` | P1 | Alerta de atraso | `tenantAuth` | 200 | `getHome` | — | — | `H-09-F.test.ts` | — |
...
| Caso | Prio | Cenário | Token | Status | Service (ação) | Services (arranjo) | Asserção literal | Teste | Bug |
|---|---|---|---|---|---|---|---|---|---|
| `API-CAT-01` | P0 | Nome de categoria único por tenant | `tenantAuth` | 409 | `postCreateCategory` | `postCreateCategory` | — | `CAT-01-F.test.ts` | [#89](https://github.com/pricaimiTech/dev.CrossHub/issues/89) |
...
| `API-CAT-15` | P2 | E-mail só com configuração completa | `endUserAuth` | 201 | `postPublicReserveProduct` | — | — | `CAT-15-F.test.ts` | — |
...
| `API-BN-08` | P1 | Configuração do carrossel | `tenantAuth` | 400 | `patchBannerSettings` | — | `Configurações do carrossel inválidas.` | `BN-08-F.test.ts` | [#105](https://github.com/pricaimiTech/dev.CrossHub/issues/105) |
...
| `API-AN-02` | P0 | Exclusão física de pessoa não existe | — | 404 | `DELETE /dashboard/people/{personId}` *(não existe no contrato)* | — | — | `AN-02-F.test.ts` | — |
...
| `API-AN-04` | P2 | Auditoria não tem evento de anonimização | `tenantAuth` | 200 | `getListPeople` | `postRunRetention` | — | `AN-04-F.test.ts` | — |
...
- `API-AG-28` → [#93](https://github.com/pricaimiTech/dev.CrossHub/issues/93) — o teste segue falhando até a correção
...
- `API-C-04` → [#99](https://github.com/pricaimiTech/dev.CrossHub/issues/99) — o teste segue falhando até a correção
- `API-F-03` → [#95](https://github.com/pricaimiTech/dev.CrossHub/issues/95) — o teste segue falhando até a correção
...
Rotas citadas por algum caso: **88** de 137 do contrato.

### Rotas `/dashboard/**` sem nenhum caso de API (24 de 94)
